...
api.barcodeInvalido(() => {
    const inputBarcode = document.getElementById('inputBarcodeProduct')
    inputBarcode.classList.add('campo-invalido') // Adiciona a classe para estilizar o foco
    inputBarcode.focus() // Coloca o foco no campo de barcode
})

// Manter o foco vermelho enquanto o campo estiver em foco
document.getElementById('inputBarcodeProduct').addEventListener('focus', () => {
    const inputBarcode = document.getElementById('inputBarcodeProduct')
    if (inputBarcode.classList.contains('campo-invalido')) {
        inputBarcode.classList.add('campo-invalido-foco') // Adiciona uma classe adicional para manter o foco vermelho
    }
})

document.getElementById('inputBarcodeProduct').addEventListener('blur', () => {
    const inputBarcode = document.getElementById('inputBarcodeProduct')
    inputBarcode.classList.remove('campo-invalido-foco') // Remove a classe adicional ao perder o foco
})
